...
// +kubebuilder:webhook:path=/mutate-batch-volcano-sh-v1alpha1-jobflow,mutating=true,failurePolicy=fail,groups=batch.volcano.sh,resources=jobflows,verbs=create;update,versions=v1alpha1,name=mjobflow.kb.io
...
// +kubebuilder:webhook:verbs=create;update,path=/validate-batch-volcano-sh-v1alpha1-jobflow,mutating=false,failurePolicy=fail,groups=batch.volcano.sh,resources=jobflows,versions=v1alpha1,name=vjobflow.kb.io
